...
class Config:
    ...
    def __init__(self):
        ...
        self.increase_pos_when_drop_down = 0.025
        ...
        # self.turnover_threshold = 10  # 100k usdt, the trading value should be higher than 100k usdt in an hour.
