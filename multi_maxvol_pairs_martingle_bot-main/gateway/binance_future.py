...
class BinanceFutureHttp(object):
        ...
        for i in range(0, self.try_counts):
            try:
                ...
                if response.status_code == 200:
                    ...
                    print(f"请求没有成功: {response.status_code}, {response.json()},继续尝试请求")
    ...
    def place_order(self, symbol: str, order_side: OrderSide, order_type: OrderType, quantity, price,
        ...
        if order_type == OrderType.MARKET:
            ...
            # if params.get('side') == OrderSide.BUY:
            #     params['positionSide'] = 'LONG'
            # if params.get('side') == OrderSide.SELL:
...
# if __name__ == '__main__':
    ...
    # key= "gAqoTTby0B0xFV9UDha9FhdM8wPVyhGsEKVQB75MyS9p0AXZUNh8RpRef9gnzGMm"
    # secret="hIQXCrAH3udXIcHFlWBBWdizLwprefcknr0DE61n5BXRy0kDa07AMfTACCgRaptW"
    ...
    #
    # data = binance.place_order(symbol="BTCUSDT", order_side=OrderSide.BUY, order_type=OrderType.MARKET, quantity=0.001, price=8250.82)
    # print(data)
